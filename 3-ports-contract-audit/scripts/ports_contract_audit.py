...
TODO_START = "<!-- ports-contract-audit:auto:start -->"
TODO_END = "<!-- ports-contract-audit:auto:end -->"
...
def update_todo(repo_root: Path, report: Dict[str, object]) -> Path:
    ...
    lines = [
        TODO_START,
        "## Ports Contract Audit (autogenerado)",
        "",
    ]
...
def main() -> int:
    ...
    if args.json:
        ...
        print(f"PORTS_CONTRACT_AUDIT={'PASS' if report['ok'] else 'FAIL'}")
