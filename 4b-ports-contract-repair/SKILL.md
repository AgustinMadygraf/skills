...
- Uso explicito: `$4b-ports-contract-repair`.
...
python ~/.codex/skills/4b-ports-contract-repair/scripts/ports_contract_repair.py --repo-root . --apply
```
