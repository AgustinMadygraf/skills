...
TODO_START = "<!-- ports-contract-repair:auto:start -->"
TODO_END = "<!-- ports-contract-repair:auto:end -->"
...
def update_todo(repo_root: Path, report: Dict[str, object], actions: List[Dict[str, str]], apply_changes: bool) -> Path:
    ...
    lines = [
        TODO_START,
        "## Ports Contract Repair (autogenerado)",
        "",
...
def main() -> int:
    ...
    if args.json:
        ...
        print(f"PORTS_CONTRACT_REPAIR={'PASS' if after['ok'] else 'FAIL'}")
